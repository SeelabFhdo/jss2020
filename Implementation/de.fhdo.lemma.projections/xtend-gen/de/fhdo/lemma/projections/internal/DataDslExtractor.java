...
public class DataDslExtractor extends AbstractGenerator {
  private static final Map<Enum<?>, String> FEATURE_TO_TEXT_MAPPINGS = Collections.<Enum<?>, String>unmodifiableMap(CollectionLiterals.<Enum<?>, String>newHashMap(Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.AGGREGATE, "aggregate"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.APPLICATION_SERVICE, "applicationService"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.DOMAIN_EVENT, "domainEvent"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.DOMAIN_SERVICE, "domainService"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.ENTITY, "entity"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.FACTORY, "factory"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.INFRASTRUCTURE_SERVICE, "infrastructureService"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.REPOSITORY, "repository"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.SERVICE, "service"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.SPECIFICATION, "specification"), Pair.<ComplexTypeFeature, String>of(ComplexTypeFeature.VALUE_OBJECT, "valueObject"), Pair.<DataFieldFeature, String>of(DataFieldFeature.IDENTIFIER, "identifier"), Pair.<DataFieldFeature, String>of(DataFieldFeature.NEVER_EMPTY, "neverEmpty"), Pair.<DataFieldFeature, String>of(DataFieldFeature.PART, "part"), Pair.<DataOperationFeature, String>of(DataOperationFeature.CLOSURE, "closure"), Pair.<DataOperationFeature, String>of(DataOperationFeature.IDENTIFIER, "identifier"), Pair.<DataOperationFeature, String>of(DataOperationFeature.SIDE_EFFECT_FREE, "sideEffectFree"), Pair.<DataOperationFeature, String>of(DataOperationFeature.VALIDATOR, "validator")));
  ...
  private String _generateComplexTypeDefinition(final Enumeration enumeration) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private String _generateComplexTypeDefinition(final DataStructure structure) {
    ...
    preamble.append(this.<ComplexTypeFeature>generateFeatures(structure.getFeatures()));
    preamble.append(" ");
  ...
  private String generateComplexTypeDefinition(final ComplexType structure) {
    if (structure instanceof DataStructure) {
      ...
      return _generateComplexTypeDefinition((Enumeration)structure);
